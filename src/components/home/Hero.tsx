			...
			<div className={`relative`}>
				...
				>
					<div className={`col-span-11 flex flex-col items-end text-white`}>
						<div className={`text-[2rem] leading-tight text-[#EEEBE3] md:text-[2.5rem] xl:text-[60px]`}>
							<div className={``}>{'Twoje materiały w '}</div>
							<div className={`text-[2rem] text-[#EEEBE3] md:text-[2.5rem] xl:text-[60px]`}>
								<span className={`pr-3 font-bold`}>jednym</span>
								<span>boxie</span>
							</div>
							<div className={`pt-4 text-[1.25rem] text-[#f6f4f0] md:text-[1.5rem] xl:text-[24px]`}>
								{tr.heroSubtitle}
							</div>
						</div>
