...
type TProps = {
	consent1: boolean;
	setConsent1: Dispatch<SetStateAction<boolean>>;
	consent2: boolean;
	setConsent2: Dispatch<SetStateAction<boolean>>;
};

export default function CartFormFooter({ setConsent2, setConsent1, consent2, consent1 }: TProps) {
